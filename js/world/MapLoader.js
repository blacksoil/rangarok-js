...
MapLoader.AtlasTextureHeight = 1024 * 2;
...
MapLoader.prototype.setupModels = function() {
	...
	console.log( "%cInfo: Loaded " + (numModels) + " resource world models", "color: #9999ff" );
...
MapLoader.prototype.setup = function() {
	...
	animate = (function() {
		...
		if(this.running) {
			...
			if(colorPick && now - lastColorPick >= this.colorPickingInterval) {
				...
				this.setWorldDisplay(true); // restore world objects
